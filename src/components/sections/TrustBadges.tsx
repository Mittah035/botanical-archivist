    ...
    <section className="py-12 px-6">
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          className="flex flex-wrap justify-center md:justify-between items-center gap-8 opacity-70 hover:opacity-100 transition-opacity duration-500"
        >
          {badges.map((badge) => (
            <div key={badge.label} className="flex items-center gap-3">
              <badge.icon className="w-5 h-5 text-emerald-400" strokeWidth={1.5} />
